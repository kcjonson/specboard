...
**Maps to:** `POST /api/projects/:owner/:project/tree`
...
**Maps to:** `GET /api/projects/:owner/:project/files?path=...`
...
**Maps to:** `POST /api/projects/:owner/:project/files?path=...` (API create handler needs modification to accept optional content in body)
...
**Maps to:** `PUT /api/projects/:owner/:project/files?path=...`
...
**Maps to:** `DELETE /api/projects/:owner/:project/files?path=...`
...
**Maps to:** `PUT /api/projects/:owner/:project/files/rename`
