...
-- NULL sessionId), so open episodes continue across the deploy. A later migration
-- drops idx_item_workers_active once no task from the previous release can run.
