...
1. **Check current work**
   - Run `/claude:whats-next` to check Specboard for current work items and priorities
...
→ Run `/claude:whats-next` — it queries Specboard MCP for live project data
...
| When You Need... | Check... |
|------------------|----------|
| Current work / project status | `/claude:whats-next` |
